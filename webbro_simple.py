...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        history_btn = QToolButton(self)
        history_btn.setText('History')
        history_btn.setIcon(QIcon('history.png'))  #Replace with whatever history icon you want
        history_btn.clicked.connect(self.show_history)
        history_btn.setFixedSize(button_width, button_width)
